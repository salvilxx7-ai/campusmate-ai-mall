...
export default function CustomerService() {
  ...
  return <div className="min-h-screen bg-background"><SiteHeader />
    <main className="container grid gap-8 py-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:py-12">
      <section>
        <div className="mb-6 max-w-2xl"><p className="text-xs font-semibold tracking-[0.15em] text-primary">GROUNDED CUSTOMER SERVICE</p><h1 className="mt-3 font-display text-4xl font-bold tracking-[-0.055em] text-foreground sm:text-5xl">只回答有据可查的事。</h1><p className="mt-4 text-sm leading-7 text-muted-foreground">CampusMate Agent 会先判断意图，再调用规则检索、商品检索、本人订单或人工转接工具。规则回答必须带引用；证据不足时会明确拒答并建议转人工。</p></div>
